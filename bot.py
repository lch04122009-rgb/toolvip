...
BOT_TOKEN  = os.getenv("BOT_TOKEN", "8547766821:AAHxHXAPqYLYWZHiDMLg78chMQeVkGySN1Y")
ADMIN_IDS  = [int(x.strip()) for x in os.getenv("ADMIN_IDS","6009450987").split(",") if x.strip().isdigit()]
